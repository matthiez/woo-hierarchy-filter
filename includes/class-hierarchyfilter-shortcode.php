...
class HierarchyFilter_Shortcode {
	...
	public function hierarchyfilter_shortcode_process_form() {
		if (!isset( $_POST['hierarchyfilter-shortcode-submit-nonce']) || !wp_verify_nonce($_POST['hierarchyfilter-shortcode-submit-nonce'], 'hierarchyfilter-shortcode-submit' )) { die(__('HierarchyFilter Shortcode: Nonce mismatch when processing form.', 'hierarchyfilter')); } 
		else {
			global $wpdb;
