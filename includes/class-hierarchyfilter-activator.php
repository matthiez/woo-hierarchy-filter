...
register_activation_hook(__FILE__, ['HierarchyFilter_Activator', 'hierarchyfilter_default_options']);
...
class HierarchyFilter_Activator
{
    ...
    public static function hierarchyfilter_create_table() {
        ...
        $wpdb->insert($table, ['level_1' => 'Daewoo', 'level_2' => 'KALOS (KLAS)', 'level_3' => '1.4 61 kW']);
        $wpdb->insert($table, ['level_1' => 'FIAT', 'level_2' => '124 Coupe', 'level_3' => '1600 77 kW']);
    }
