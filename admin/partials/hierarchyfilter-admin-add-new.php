<div class="wrap">
    ...
    <form action="<?php //echo esc_url( admin_url('admin-post.php') ); ?>" method="post">
        ...
        <p class="hierarchyfilter-admin-add-new-input"><?php _e('Level 2', 'hierarchyfilter'); ?></br>
            <input type="text" name="hierarchyfilter-add-new-level-2" id="hierarchyfilter-add-new-level-2" placeholder="First specify a level 1 entry."
                   value=""/>
        ...
        <p class="hierarchyfilter-admin-add-new-input"><?php _e('Level 3', 'hierarchyfilter'); ?></br>
            <input type="text" name="hierarchyfilter-add-new-level-3" id="hierarchyfilter-add-new-level-3" placeholder="First specify a level 2 entry."
                   value=""/>
        ...
        <!-- BUTTONS -->
        <input type="submit" class="button button-primary" name="hierarchyfilter-admin-add-new-submit" id="hierarchyfilter-admin-add-new-submit"
               value="Add New"/>
        <input type="reset" id="hierarchyfilter-admin-add-new-reset" value="Reset Fields"/>
        <input type="hidden" name="hierarchyfilter-admin-add-new-nonce" id="hierarchyfilter-admin-add-new-nonce"
               value="<?php echo wp_create_nonce('2305813681361') ?>"/>
    </form>
